...
--]] ---------------------------------------------------------
	...
	--[[---------------------------------------------------------
	- func: SetPadding(v, h) SetVerticalPadding(v) SetHorizontalPadding(h)
	- desc: sets the object's padding
--]] ---------------------------------------------------------
	function TextBox:SetPadding(v, h)
		self.verticalpadding = v
		self.horizontalpadding = h
		return self
	end

	function TextBox:SetVerticalPadding(v)
		self.verticalpadding = v
		return self
	end

	function TextBox:SetHorizontalPadding(h)
		self.horizontalpadding = h
		return self
	end
...
--]] ---------------------------------------------------------
	function TextBox:GetPadding()
		return self:GetVerticalPadding(), self:GetHorizontalPadding()
	end

	function TextBox:GetVerticalPadding()
		if self.verticalalignment == "center" then
			return (self.height - self.field:getTextHeight()) / 2
		elseif self.verticalalignment == "bottom" then
			return self.height - self.field:getTextHeight()
		else
...
--]] ---------------------------------------------------------
	...
	- desc: sets the object's text alignment
--]] ---------------------------------------------------------
	function TextBox:SetAlignment(alignment)
		self.field:setAlignment(alignment)
		return self
	end

	--[[---------------------------------------------------------
	- func: GetAlignment()
	- desc: gets the object's text alignment
--]] ---------------------------------------------------------
	function TextBox:GetAlignment()
		return self.field:getAlignment()
	end

	--[[---------------------------------------------------------
	- func: SetVerticalAlignment(alignment)
	- desc: sets the object's vertical text alignment
--]] ---------------------------------------------------------
	...
	- desc: gets the object's vertical text alignment
--]] ---------------------------------------------------------
	function TextBox:GetVerticalAlignment()
