...
--]] ---------------------------------------------------------
	function MenuOption:mousereleased(x, y, button)
		...
		if hover and option_type ~= "divider" and self.enabled and button == 1 then
...
--]] ---------------------------------------------------------
	...
	- desc: sets the object's enabled state
--]] ---------------------------------------------------------
	function MenuOption:SetEnabled(bool)
		self.enabled = bool
		return self
	end
	...
	--[[---------------------------------------------------------
	- func: GetEnabled()
	- desc: gets the object's enabled state
--]] ---------------------------------------------------------
	function MenuOption:GetEnabled()
		return self.enabled
	end
