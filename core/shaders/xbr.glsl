...
/* FRAGMENT SHADER */
vec3 four_xBRZ(vec2 texture_size,vec2 texCoord, Image tex)
{
	...
	src[21] = texture(tex, floor(t1.xw*texture_size)/texture_size).rgb;
	src[22] = texture(tex, floor(t1.yw*texture_size)/texture_size).rgb;
	src[23] = texture(tex, floor(t1.zw*texture_size)/texture_size).rgb;
	src[ 6] = texture(tex, floor(t2.xw*texture_size)/texture_size).rgb;
	src[ 7] = texture(tex, floor(t2.yw*texture_size)/texture_size).rgb;
	src[ 8] = texture(tex, floor(t2.zw*texture_size)/texture_size).rgb;
	src[ 5] = texture(tex, floor(t3.xw*texture_size)/texture_size).rgb;
	src[ 0] = texture(tex, floor(t3.yw*texture_size)/texture_size).rgb;
	src[ 1] = texture(tex, floor(t3.zw*texture_size)/texture_size).rgb;
	src[ 4] = texture(tex, floor(t4.xw*texture_size)/texture_size).rgb;
	src[ 3] = texture(tex, floor(t4.yw*texture_size)/texture_size).rgb;
	src[ 2] = texture(tex, floor(t4.zw*texture_size)/texture_size).rgb;
	src[15] = texture(tex, floor(t5.xw*texture_size)/texture_size).rgb;
	src[14] = texture(tex, floor(t5.yw*texture_size)/texture_size).rgb;
	src[13] = texture(tex, floor(t5.zw*texture_size)/texture_size).rgb;
	src[19] = texture(tex, floor(t6.xy*texture_size)/texture_size).rgb;
	src[18] = texture(tex, floor(t6.xz*texture_size)/texture_size).rgb;
	src[17] = texture(tex, floor(t6.xw*texture_size)/texture_size).rgb;
	src[ 9] = texture(tex, floor(t7.xy*texture_size)/texture_size).rgb;
	src[10] = texture(tex, floor(t7.xz*texture_size)/texture_size).rgb;
	src[11] = texture(tex, floor(t7.xw*texture_size)/texture_size).rgb;
...
vec4 effect( vec4 color, Image tex, vec2 tex_uv, vec2 fragCoord )
{
	vec2 tex_size = vec2(textureSize(tex, 0));
    vec3 final_color = four_xBRZ(tex_size, tex_uv,  tex);
