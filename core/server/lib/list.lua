...
---@field _first number?
---@field _last number?
---@field _value table<number, table>
---@field _prev table<number, number>
---@field _next table<number, number>
---@field count fun(List): number
---@field first fun(List): number?
---@field last fun(List): number?
---@field contains fun(List, value: any): boolean
---@field push fun(List, value: any): boolean
---@field pushf fun(List, value: any): boolean
---@field pushl fun(List, value: any): boolean
---@field remove fun(List, value: any): any
---@field popf fun(List): any
---@field popl fun(List): any
---@field clear fun(List): nil
---@field range fun(List, from: number, to: number): any[]
---@field walk fun(List, seq?: boolean): function<any, number, any>
---@field new fun(): List
local List = {}
List.__index = List
